      ...
      <div className={styles.guidelinePage_body}>
        <div className={styles.guidelinePage_Top}>
          <h1 className={styles.h1}>
            YAY! We are excited to have you onboard!
          </h1>
        </div>
        ...
        <div className={styles.guideline_rules_right}>
          ...
          <p>
            ...
            not allowed - we are committed to creating a safe and welcoming
            space for everyone!
          </p>
        </div>
        ...
        <div className={styles.guideline_rules_left}>
          ...
          <p className={styles.guideline_p}>
            Please do not pretend to be someone else or create fake accounts -
        ...
        <div className={styles.guideline_rules_center}>
          ...
          <p className={styles.guideline_p_center}>
            Do not be afraid to show your true self and share your passion- it
            is the best way to make lasting connections with others. So go ahead
        ...
        <div className={styles.fieldset_div}>
          <fieldset className={styles.guideline_fieldset_bottom}>
            <p className={styles.fieldset_p}>
              We stand firmly against hate speech of any kind. Failure in
              treating our community users with respect or engaging in either
              racism, homophobia, ableism, sexism or any other kind of
              discrimination, will result in your post being deleted and a
              warning.
            </p>
          </fieldset>
        </div>
